...
// // Contexts
// import { UserContext } from "./Components/Context/Context"; // Your existing UserContext
// import { DataStoreProvider } from './ClusterScreen/DataStoreContext'; // <-- Corrected path for DataStoreProvider
...
//   const [loadingApp, setLoadingApp] = useState(true); // Renamed from 'loading' to avoid confusion with DataStore's loading
//   const [isUnderMaintenance, setIsUnderMaintenance] = useState(null); // null = unknown
...
//         setIsUnderMaintenance(false);
//       } finally {
//         setLoadingApp(false); // Use the new loadingApp state
//       }
//     };
...
//   if (!isFontLoaded || loadingApp) { // Use loadingApp here
//     return (
//       <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
//         <ActivityIndicator size="large" />
//       </View>
...
//   return (
//     <UserContext.Provider value={{ user, setUser }}>
//       <DataStoreProvider> {/* <-- NEW: Wrap your app with DataStoreProvider */}
//         <StatusBar />
//         <NavigationContainer theme={navTheme} ref={navigationRef}>
//           <SafeAreaProvider>
//             <Stack.Navigator
...
//           </SafeAreaProvider>
//         </NavigationContainer>
//       </DataStoreProvider> {/* <-- NEW: Close DataStoreProvider */}
//     </UserContext.Provider>
//   );
// }