...
import NativeTabView from "./TabViewNativeComponent.js";
...
const TabView = ({
  ...
  }), [trimmedRoutes, icons, getLabelText, getBadge, getActiveTintColor, getHidden, getTestID]);
  ...
  icons.map(icon => icon && !isAppleSymbol(icon) ? Image.resolveAssetSource(icon) : {
    uri: ''
  }), [icons]);
  ...
  return /*#__PURE__*/_jsxs(BottomTabBarHeightContext.Provider, {
    ...
    children: [/*#__PURE__*/_jsx(NativeTabView, {
      ...
      children: trimmedRoutes.map(route => {
        ...
        return /*#__PURE__*/_jsx(View, {
          style: [styles.screen, renderCustomTabBar ? styles.fullWidth : measuredDimensions],
          collapsable: false,
