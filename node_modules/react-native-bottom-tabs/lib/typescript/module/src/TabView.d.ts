...
declare const TabView: <Route extends BaseRoute>({ navigationState, renderScene, onIndexChange, onTabLongPress, getBadge, rippleColor, tabBarActiveTintColor: activeTintColor, tabBarInactiveTintColor: inactiveTintColor, getLazy, getLabelText, getIcon, getHidden, getActiveTintColor, getTestID, hapticFeedbackEnabled, labeled, getFreezeOnBlur, tabBar: renderCustomTabBar, tabBarStyle, tabLabelStyle, ...props }: Props<Route>) => import("react/jsx-runtime").JSX.Element;
